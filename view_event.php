...
<link rel="stylesheet" href="./css/gallery.css">
    ...
    <header class="bg-maroon text-white">
        <div class="mt-5"></div>
        <h1><?php echo ucwords($title) ?> <br> <span>[ <?php echo $date_created ?> ]</span></h1>
    </header>
<!-- <header class="masthead">
	<div class="container-fluid h-100">
		<div class="row h-100 align-items-center justify-content-center text-center">
			<div class="col-lg-4 align-self-end mb-4 pt-2 page-title">
				<style>.title-event { font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; }</style>
				<h1 class="text-center text-white title-event"><b><?php echo ucwords($title) ?></b></h1>
			...
			<div class="card-body">
				<div class="row">
					<div class="col-md-12 img">
						<img src="./admin/assets/uploads/<?php echo $banner ?>" alt="">
					</div>
					<div class="col-md-12" id="content">
					<p class="">
						<p class="text-maroon"><b><i class="fa fa-calendar"></i> <?php echo date("F d, Y h:i A",strtotime($schedule)) ?></b></p>
					...
					<div class="col-md-12">
						...
						<div class="text-center">
							...
							<?php if(in_array($_SESSION['login_id'], $cids)): ?>
								<span class="badge text-maroon" style="font-size: medium;">Commited to Participate</span>
							<?php else: ?>
								<button class="btn bg-maroon text-white" id="participate" type="button">Participate</button>
							<?php endif; ?>
							<?php endif; ?>
						</div>
					</div>
				...
				<div>
					<?php if (!isset($_SESSION['login_type'])): ?>
						<hr class="divider">					
						<div class="text-center">
						<span class="badge text-maroon mt-2 mb-2" style="font-size: medium;">Participating Alumnus</span>
						</div>
								...
								<tr>
									...
									<td class="d-flex justify-content-center">
										<div class="avatar bg-maroon">
											<img height="40px" src="./admin/assets/uploads/<?php echo $row['avatar'] ?>" class="" alt="">
										</div>
									</td>
									<td class="">
